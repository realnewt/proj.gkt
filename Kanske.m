...
cat_tot=1000; %kg cat
XA_start=0;
T0=850; %constant start temp. for every reactor in kelvin
FA0=100; FB0=0; FW0=10*FA0; %molar flowrates in to the first reactor mol/s
...
CP=[1.39 0.3847 -1.846e-04 2.895e-08;
    ...
    32.24 0.001924 1.055e-05 -3.596e-09]; %matrix with all CP constant J/mol/K
